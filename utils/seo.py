...
def inject_seo_meta(
    ...
    og_image: str = None,
    author: str = "Research Ethics Mastery Hub",
    ...
    base_url = "https://researchethics.dev"
    ...
    main_schema = {
        ...
        "publisher": {
            "@type": "Organization",
            "@id": f"{base_url}#organization",
            "name": "Research Ethics Mastery Hub",
            "logo": {
                "@type": "ImageObject",
                "url": f"{base_url}/assets/logo.png",
                "width": 600,
    ...
    website_schema = {
        ...
        "name": "Research Ethics Mastery Hub",
        "url": base_url,
        "description": "Comprehensive Ph.D. course on Ethics in Research and Publications with interactive tutorials and real-world case studies",
    ...
    if course_info:
        course_schema = {
            ...
            "educationalLevel": course_info.get("level", "Doctoral"),
    ...
    org_schema = {
        ...
        "sameAs": [
            "https://github.com/research-ethics-mastery",
            "https://twitter.com/researchethics"
        ],
        "contactPoint": {
            "@type": "ContactPoint",
            "contactType": "customer support",
            "email": "support@researchethics.dev"
        }
    }
